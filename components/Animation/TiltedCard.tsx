...
// import "../../pages/CSS/TiltedCard.css";
import "@/styles/TiltedCard.css";

interface TiltedCardProps {
  imageSrc: React.ComponentProps<"img">["src"] | any;
  altText?: string;
  captionText?: string;
...
export default function TiltedCard({
  ...
  function handleMouse(e: React.MouseEvent<HTMLElement>) {
    ...
    const offsetX = e.clientX - rect.left - rect.width / 1;
    const offsetY = e.clientY - rect.top - rect.height / 1;
